...
@customElement('ninearm-button')
export class NineArmButton extends LitElement {
    ...
    static get styles() {
        return css`
            ...
            #button {
                ...
                box-shadow: 0 2px 4px #00000070, 0 4px 16px #00000050,
                    0 16px 40px #00000050;
                border: 0;
                outline: none;
                cursor: pointer;
            ...
            #button:hover,
            #button:focus {
                box-shadow: 0 2px 4px #00000080, 0 20px 48px #00000060,
                    0 16px 40px #00000060;
            }
            #title {
